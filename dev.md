...
- write Track B and Track C tests RED first for the current story from the approved planning outputs (`task_spec_document.md`, including the QA Scenario Matrix references for Track B and the platform/framework chosen in `architecture.md`)
